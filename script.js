(function () {
  ...
  const pastaTemplates = [
    ...
    { name: 'の和風パスタ', base: ['スパゲッティ', '醤油', 'だし', 'ごま油', 'ねぎ', '塩', 'こしょう'] },
    { name: 'のペペロンチーノ', base: ['スパゲッティ', 'にんにく', 'オリーブオイル', '唐辛子', '塩', 'こしょう', 'パセリ'] },
    { name: 'のアーリオ・オーリオ', base: ['スパゲッティ', 'にんにく', 'オリーブオイル', '塩', 'こしょう', 'パセリ'] },
    { name: 'のカルボナーラ風', base: ['スパゲッティ', '卵', '生クリーム', 'ベーコン', '粉チーズ', '塩', 'こしょう'] },
    { name: 'のガーリックオイルパスタ', base: ['スパゲッティ', 'にんにく', 'オリーブオイル', '塩', 'こしょう', 'パセリ', 'レモン'] },
    { name: 'のジェノベーゼ風', base: ['スパゲッティ', 'バジル', 'にんにく', '松の実', 'オリーブオイル', '粉チーズ', '塩'] },
    { name: 'のバター醤油パスタ', base: ['スパゲッティ', 'バター', '醤油', 'ねぎ', 'ごま', '塩', 'こしょう'] },
    { name: 'の冷製パスタ', base: ['スパゲッティ', 'オリーブオイル', 'レモン', 'にんにく', 'バジル', '塩', 'こしょう'] },
    { name: 'のナポリタン風', base: ['スパゲッティ', 'トマトケチャップ', '玉ねぎ', 'ピーマン', 'ウスターソース', '塩', 'こしょう'] },
    { name: 'のチーズクリームパスタ', base: ['スパゲッティ', '生クリーム', '粉チーズ', 'バター', 'にんにく', '塩', 'こしょう'] },
    { name: 'のレモンバターパスタ', base: ['スパゲッティ', 'バター', 'レモン', 'にんにく', '白ワイン', 'パセリ', '塩', 'こしょう'] },
    { name: 'の和風ねぎだしパスタ', base: ['スパゲッティ', '長ねぎ', 'だし', '醤油', 'ごま油', 'すりごま', '塩'] },
    { name: 'のアジアン風パスタ', base: ['スパゲッティ', 'にんにく', 'ごま油', 'ラー油', '醤油', 'ねぎ', 'ごま'] },
    { name: 'のコンソメバターパスタ', base: ['スパゲッティ', 'コンソメ', 'バター', 'にんにく', 'パセリ', '塩', 'こしょう'] },
    { name: 'のオイルソースパスタ', base: ['スパゲッティ', 'オリーブオイル', 'にんにく', '唐辛子', 'アンチョビ', 'パセリ', '塩'] },
    { name: 'の和風明太子風味', base: ['スパゲッティ', '明太子', 'バター', 'のり', 'ねぎ', '醤油'] },
  ];
  ...
  function suggestPasta(main, excludeList) {
    ...
    return picked.map(function (t) {
      ...
      const ingredients = getIngredientsForMenu(trimmed, t);
      return { menuName: menuName, ingredients: ingredients };
    });
  }
